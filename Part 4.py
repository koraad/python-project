...
text_file = open("ProgressionData", "w")
...
----------------------------------------------------------------             
        ...
        for scores in credit_scores_progress:
            text_file.write(f"Progress - {scores}\n")
        for scores in credit_scores_trailing:
            text_file.write(f"Progress (module trailer) - {scores}\n")
        for scores in credit_scores_retriever:
            text_file.write(f"Module retriever - {scores}\n")
        for scores in credit_scores_exclude:
            text_file.write(f"Exclude - {scores}\n")

        text_file.flush()
        text_file.close()
        break

file_reading = open("ProgressionData", "r")
